...
const ALL_BADGES: BadgeDefinition[] = [
  // ─── الجداول (Tables) ───
  { id: 'table-master-1', emoji: '🏝️', name: 'مستكشف الجزيرة', description: 'أتقن جدول 1', category: 'الجداول' },
  { id: 'table-master-2', emoji: '🌳', name: 'مغامر الغابة', description: 'أتقن جدول 2', category: 'الجداول' },
  { id: 'table-master-3', emoji: '🌊', name: 'غواص البحر', description: 'أتقن جدول 3', category: 'الجداول' },
  { id: 'table-master-4', emoji: '⛰️', name: 'متسلق الجبل', description: 'أتقن جدول 4', category: 'الجداول' },
  { id: 'table-master-5', emoji: '🍬', name: 'صانع الحلوى', description: 'أتقن جدول 5', category: 'الجداول' },
  { id: 'table-master-6', emoji: '🚀', name: 'رائد الفضاء', description: 'أتقن جدول 6', category: 'الجداول' },
  { id: 'table-master-7', emoji: '🏰', name: 'حارس القلعة', description: 'أتقن جدول 7', category: 'الجداول' },
  { id: 'table-master-8', emoji: '🎨', name: 'فنان الألوان', description: 'أتقن جدول 8', category: 'الجداول' },
  { id: 'table-master-9', emoji: '👑', name: 'ملك الأبطال', description: 'أتقن جدول 9', category: 'الجداول' },
  { id: 'all-tables', emoji: '🏆', name: 'بطل الضرب الكامل', description: 'أتقن جميع الجداول التسعة', category: 'الجداول' },

  // ─── السلاسل (Streaks) ───
  { id: 'streak-3', emoji: '🔥', name: 'شرارة البداية', description: 'سلسلة 3 أيام متتالية', category: 'السلاسل' },
  { id: 'streak-7', emoji: '💫', name: 'نجم الإصرار', description: 'سلسلة 7 أيام متتالية', category: 'السلاسل' },
  { id: 'streak-14', emoji: '⚡', name: 'قوة البرق', description: 'سلسلة 14 يوم متتالي', category: 'السلاسل' },
  { id: 'streak-30', emoji: '🌟', name: 'نجم الثبات', description: 'سلسلة 30 يوم متتالي', category: 'السلاسل' },
  { id: 'streak-100', emoji: '🌈', name: 'أسطورة المثابرة', description: 'سلسلة 100 يوم متتالي', category: 'السلاسل' },

  // ─── النقاط (Points) ───
  { id: 'points-100', emoji: '🪙', name: 'جامع العملات', description: 'اجمع 100 نقطة', category: 'النقاط' },
  { id: 'points-500', emoji: '💰', name: 'كنز المعرفة', description: 'اجمع 500 نقطة', category: 'النقاط' },
  { id: 'points-1000', emoji: '💎', name: 'ماسي', description: 'اجمع 1000 نقطة', category: 'النقاط' },
  { id: 'points-5000', emoji: '👑', name: 'إمبراطور النقاط', description: 'اجمع 5000 نقطة', category: 'النقاط' },

  // ─── الخاصة (Special) ───
  { id: 'first-game', emoji: '🎮', name: 'اللاعب الجديد', description: 'العب أول لعبة', category: 'الخاصة' },
  { id: 'speed-demon', emoji: '⚡', name: 'الفلاتة', description: 'أجبت في أقل من 3 ثوان', category: 'الخاصة' },
  { id: 'perfect-game', emoji: '💯', name: 'بلا أخطاء', description: 'أكمل جولة بدون أي خطأ', category: 'الخاصة' },
  { id: 'night-owl', emoji: '🦉', name: 'بومة الليل', description: 'العب بعد منتصف الليل', category: 'الخاصة' },
  { id: 'early-bird', emoji: '🐦', name: 'طائر الصباح', description: 'العب قبل الساعة 7 صباحاً', category: 'الخاصة' },
  { id: 'comeback', emoji: '🦸', name: 'بطل العودة', description: 'تحسن في جدول كان ضعيفاً فيه', category: 'الخاصة' },
  { id: 'daily-warrior', emoji: '📅', name: 'محب التحدّيات', description: 'أكمل تحدي يومي', category: 'الخاصة' },
  { id: 'story-chapter-1', emoji: '📖', name: 'راوي القصص', description: 'أكمل قصة كاملة', category: 'الخاصة' },
  { id: 'combo-5', emoji: '🔥', name: 'سلسلة 5', description: '5 إجابات صحيحة متتالية', category: 'الخاصة' },
  { id: 'combo-10', emoji: '💥', name: 'سلسلة 10', description: '10 إجابات صحيحة متتالية', category: 'الخاصة' },
  { id: 'combo-25', emoji: '⚡', name: 'سلسلة 25', description: '25 إجابة صحيحة متتالية', category: 'الخاصة' },
  { id: 'combo-50', emoji: '🌟', name: 'سلسلة 50', description: '50 إجابة صحيحة متتالية', category: 'الخاصة' },
  { id: 'explorer', emoji: '🗺️', name: 'مستكشف', description: 'العب كل أنواع الألعاب', category: 'الخاصة' },
];
