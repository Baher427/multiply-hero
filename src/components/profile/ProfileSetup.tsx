...
const AVATARS: AvatarItem[] = [
  ...
  { id: 'bunny', emoji: '🐰', name: 'أرنب', category: 'animals', unlockLevel: 0 },
  ...
  { id: 'star-eyes', emoji: '🤩', name: 'مبهر', category: 'faces', unlockLevel: 0 },
  { id: 'cool', emoji: '😎', name: 'رائع', category: 'faces', unlockLevel: 0 },
  { id: 'hearts', emoji: '😍', name: 'محب', category: 'faces', unlockLevel: 1 },
  { id: 'party', emoji: '🥳', name: 'احتفال', category: 'faces', unlockLevel: 2 },
  { id: 'nerd', emoji: '🤓', name: 'ذكي', category: 'faces', unlockLevel: 3 },
  ...
  { id: 'diamond', emoji: '💎', name: 'ماسة', category: 'objects', unlockLevel: 4 },
...
export default function ProfileSetup({ onComplete, onBack }: ProfileSetupProps) {
  ...
  }, [name, displayName, age, avatarId, favoriteColor, onComplete]);
